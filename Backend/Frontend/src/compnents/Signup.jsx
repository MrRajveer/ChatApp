        ...
        <>
            ...
            <div className='flex h-screen items-center justify-center'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='border border-black px-6 py-3 rounded-md  space-y-3 w-96'>
                    ...
                    <h2 className='text-2xl items-center'>Create a new <span className='text-blue-600 font-semibold'>
                    Account
                        </span></h2>
                        ...
                        <input type="submit" value="Signup" className='text-white bg-blue-600 cursor-pointer w-full rounded-lg py-2' />
                        </div>
